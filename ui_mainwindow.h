...
""));
        ...
        smoothX_lin = new QLineEdit(frame);
        smoothX_lin->setObjectName(QString::fromUtf8("smoothX_lin"));
        smoothX_lin->setGeometry(QRect(590, 90, 101, 41));
        sizePolicy.setHeightForWidth(smoothX_lin->sizePolicy().hasHeightForWidth());
        smoothX_lin->setSizePolicy(sizePolicy);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        smoothX_lin->setText(QApplication::translate("MainWindow", "0", nullptr));
