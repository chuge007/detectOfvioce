...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(0, 1350, 1611, 51));
        ...
        label_15->setGeometry(QRect(350, 1360, 111, 31));
