...
public:
    ...
    void setupUi(QDialog *addRoute_dialog)
    {
        ...
        yEnd_lin->setGeometry(QRect(150, 40, 91, 31));
        ...
        zEnd_lin->setGeometry(QRect(250, 40, 91, 31));
